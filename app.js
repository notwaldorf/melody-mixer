...
const numInterpolations = 2; //numInterpolations containing 32 notes
let MELODY1 = presetMelodies['Melody 1'];
let MELODY2 = presetMelodies['Melody 2'];
const melodiesModelCheckPoint = 'https://storage.googleapis.com/magentadata/js/checkpoints/music_vae/mel_2bar_small';
...
function interpolateMelodies(){
  interpolatedNoteSequence musicVAE.interpolate([MELODY1, MELODY2], numInterpolations);
  ...
  interpolatedNoteSequencess =[interpolatedNoteSequences.length-1] = MELODY2;
}
